packages <- c("shiny", "magrittr", "ggplot2", "dplyr", "leaflet", "ggmap", "maps", "raster", "sp", "rgdal", "shinysky", "shinythemes", "shinyWidgets", "shinycssloaders", "shinyjs", "colorRamps")
...
shinyUI <- fluidPage(
  ...
  p("This application uses a biophysical model that was adapted from Buckley and Kingsolver ()"),
